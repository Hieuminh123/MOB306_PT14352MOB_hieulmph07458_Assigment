...
function App() {
    const API = "https://5e6713581937020016fed552.mockapi.io/api/subjects"
    const fetchSubjects = () => {
    ...
    const createItem = () => {
        ...
        // urlencoded.append("thumbnail", "http://st.nettruyen.com/data/comics/97/torimibu-no-takanashi-san.jpg");
        // urlencoded.append("name", "Torimibu no Takanashi-sanaaaaaa");
        // urlencoded.append("category", "Tình cảmaaaa");
        // urlencoded.append("total_chapters", "12aaa");
        // urlencoded.append("is_full", "falseaaa");
        ...
        // fetch("https://5e6713581937020016fed552.mockapi.io/api/subjects", requestOptions)
